...
namespace DarkTonic.MasterAudio.EditorScripts
{
    ...
    public class BulkAudioImporter : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            var myPosition = GUILayoutUtility.GetRect(10, 10, ToolbarSearchCancelButton);
            myPosition.x -= 5;
            if (GUI.Button(myPosition, "", ToolbarSearchCancelButton))
            {
        ...
        private static GUIStyle ToolbarSearchCancelButton { get { return GetStyle("ToolbarSearchCancelButton"); } }
