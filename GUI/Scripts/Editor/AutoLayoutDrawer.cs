...
namespace Aura.Editor.GUIs
{
    ...
    internal class AutoLayoutDrawer : AuraPropertyDrawer<_AutoLayout>
    {
        protected override float GetPropertyHeight(GUIContent label)
        {
            ...
            return 9f * PropertyDrawerUtils.SingleLineHeight + EditorGUI.GetPropertyHeight(wrapper.CrossProp);
        }
        ...
        protected override void OnGUI(Rect position, GUIContent label)
        {
            ...
            using (new EditorGUI.IndentLevelScope(1))
            {
                ...
                position.BumpLine();
                EditorGUI.PropertyField(position, wrapper.OffsetProp);

                position.BumpLine();
                EditorGUI.PropertyField(position, wrapper.CrossProp);
            }
