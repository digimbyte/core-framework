...
namespace Nova
{
    ...
    public static class Data
    {
        ...
        internal static OnBind<TData> Bind<TData>(ItemView container, TData data)
        {
            return new OnBind<TData>()
            {
                Target = container.UIBlock,
                Receiver = container.UIBlock,
                UserData = data,
                View = container,
            };
        }

        internal static OnUnbind<TData> Unbind<TData>(ItemView container, TData data)
        {
        ...
        public struct OnBind<TData> : IEvent, System.IEquatable<OnBind<TData>>
        {
            ...
            {
                int hash = 13;
                hash = (hash * 7) + this.GetHashCodeBase();

                if (View != null)
                {
                    hash = (hash * 7) + View.GetHashCode();
                }
    ...
    {
        #region Internal Utils
        internal static OnMove Move(Interaction.Update gesture, UIBlock receiver, Vector3 position) => new OnMove() { Interaction = gesture, Target = receiver, Receiver = receiver, PointerWorldPosition = position };
        internal static OnHover Hover(Interaction.Update gesture, UIBlock receiver, Vector3 position) => new OnHover() { Interaction = gesture, Target = receiver, Receiver = receiver, PointerWorldPosition = position };
        internal static OnUnhover Unhover(Interaction.Update gesture, UIBlock receiver) => new OnUnhover() { Interaction = gesture, Target = receiver, Receiver = receiver };
        internal static OnPress Press(Interaction.Update gesture, UIBlock receiver, Vector3 position) => new OnPress() { Interaction = gesture, Target = receiver, Receiver = receiver, PointerWorldPosition = position };
        internal static OnRelease Release(Interaction.Update gesture, UIBlock receiver, bool hovering, bool wasDragged) => new OnRelease() { Interaction = gesture, Target = receiver, Receiver = receiver, Hovering = hovering, WasDragged = wasDragged };
        internal static OnClick Click(Interaction.Update gesture, UIBlock receiver) => new OnClick() { Interaction = gesture, Target = receiver, Receiver = receiver };
        internal static OnScroll Scroll(Interaction.Update gesture, UIBlock receiver, ScrollType type, Vector3 delta) => new OnScroll() { Interaction = gesture, Target = receiver, Receiver = receiver, ScrollDeltaLocalSpace = delta, ScrollType = type };
        internal static OnDrag Drag(Interaction.Update gesture, UIBlock receiver, ref Positions rawPositions, ref Positions positions, ThreeD<bool> axes) => new OnDrag() { Interaction = gesture, Target = receiver, Receiver = receiver, RawPointerPositions = rawPositions, PointerPositions = positions, DraggableAxes = axes };
        internal static OnCancel Cancel(Interaction.Update gesture, UIBlock receiver) => new OnCancel() { Interaction = gesture, Target = receiver, Receiver = receiver };
        #endregion
        ...
        public struct Positions : System.IEquatable<Positions>
        {
            ...
            {
                if (transform == null || !Util.Any(axisMask))
                {
                    return Vector3.zero;
                }

                Vector3 maskedLocalTranslation = Vector3.Scale(GetTranslationInLocalSpace(transform, from, to), Util.Mask(axisMask));
                return transform.TransformVector(maskedLocalTranslation);
            }
        ...
        public struct OnMove : IGestureEvent, System.IEquatable<OnMove>
        {
            ...
            {
                int hash = 13;
                hash = (hash * 7) + IGestureEventExtensions.GetHashCodeBase(this);
                hash = (hash * 7) + PointerWorldPosition.GetHashCode();
                return hash;
            }
        ...
        public struct OnRelease : IGestureEvent, System.IEquatable<OnRelease>
        {
            ...
            public override int GetHashCode()
            {
                int hash = 13;
                hash = (hash * 7) + IGestureEventExtensions.GetHashCodeBase(this);
                hash = (hash * 7) + Hovering.GetHashCode();
                hash = (hash * 7) + WasDragged.GetHashCode();
        ...
        public struct OnScroll : IGestureEvent, System.IEquatable<OnScroll>
        {
            ...
            public override int GetHashCode()
            {
                int hash = 13;
                hash = (hash * 7) + IGestureEventExtensions.GetHashCodeBase(this);
                hash = (hash * 7) + ((int)ScrollType).GetHashCode();
                hash = (hash * 7) + ScrollDeltaLocalSpace.GetHashCode();
                return hash;
            }
        ...
        public struct OnDrag : IGestureEvent, System.IEquatable<OnDrag>
        {
            ...
            public override int GetHashCode()
            {
                int hash = 13;
                hash = (hash * 7) + IGestureEventExtensions.GetHashCodeBase(this);
                hash = (hash * 7) + RawPointerPositions.GetHashCode();
                hash = (hash * 7) + PointerPositions.GetHashCode();
                hash = (hash * 7) + DraggableAxes.GetHashCode();
                return hash;
            }
    ...
    {
        internal static OnMoveTo MoveTo(Interaction.Update gesture, UIBlock receiver, UIBlock fromUIBlock, Vector3 direction) => new OnMoveTo() { Interaction = gesture, Target = receiver, Receiver = receiver, FromUIBlock = fromUIBlock, Direction = direction };
        internal static OnMoveFrom MoveFrom(Interaction.Update gesture, UIBlock receiver, UIBlock toUIBlock, Vector3 direction) => new OnMoveFrom() { Interaction = gesture, Target = receiver, Receiver = receiver, ToUIBlock = toUIBlock, Direction = direction };
        internal static OnDirection Direction(Interaction.Update gesture, UIBlock receiver, Vector3 direction) => new OnDirection() { Interaction = gesture, Target = receiver, Receiver = receiver, Direction = direction };
        internal static OnSelect Select(Interaction.Update gesture, UIBlock receiver) => new OnSelect() { Interaction = gesture, Target = receiver, Receiver = receiver };
        internal static OnDeselect Deselect(Interaction.Update gesture, UIBlock receiver) => new OnDeselect() { Interaction = gesture, Target = receiver, Receiver = receiver };
        ...
        public struct OnMoveTo : IGestureEvent, System.IEquatable<OnMoveTo>
        {
            ...
            public override int GetHashCode()
            {
                ...
                if (FromUIBlock != null)
                {
                    hash = (hash * 7) + FromUIBlock.GetHashCode();
                }
        ...
        public struct OnMoveFrom : IGestureEvent, System.IEquatable<OnMoveFrom>
        {
            ...
            public override int GetHashCode()
            {
                ...
                if (ToUIBlock != null)
                {
                    hash = (hash * 7) + ToUIBlock.GetHashCode();
                }
    ...
    public static class IEventExtensions
    {
        ...
        {
            Events.EventModule.Consume(ref evt);
        }
    }

    #region Internal
    internal static class IEventInternalExtensions
    {
        public static int GetHashCodeBase<T>(this T evt) where T : struct, IEvent
        {
            int hash = 13;

            hash = (hash * 7) + evt.ID.GetHashCode();

            if (evt.Target != null)
            {
                hash = (hash * 7) + evt.Target.GetHashCode();
            }

            if (evt.Receiver != null)
            {
                hash = (hash * 7) + evt.Receiver.GetHashCode();
            }
    ...
    internal static class IGestureEventExtensions
    {
        public static int GetHashCodeBase<T>(this T evt) where T : struct, IGestureEvent
        {
            int hash = 13;
            hash = (hash * 7) + IEventInternalExtensions.GetHashCodeBase(evt);
            hash = (hash * 7) + evt.Interaction.GetHashCode();
