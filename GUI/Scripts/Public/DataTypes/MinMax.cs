...
namespace Nova
{
    ...
    {
        internal const int SizeOf = Internal.Length.MinMax.SizeOf;
        ...
        {
            return $"[{Min.ToString(FormatUtils.FloatFormat, FormatUtils.Formatter)}, {Max.ToString(FormatUtils.FloatFormat, FormatUtils.Formatter)}]";
        }
    }
}
