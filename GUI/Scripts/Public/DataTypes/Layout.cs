...
namespace Nova
{
    ...
    public enum AutoSize
    {
        ...
        /// No autosizing
        /// </summary>
        None = Internal.AutoSize.None,
        /// <summary>
        /// Match size of parent
        /// </summary>
        Expand = Internal.AutoSize.Expand,
        /// <summary>
        /// Match size of children
        /// </summary>
        Shrink = Internal.AutoSize.Shrink,
    };
    ...
    public struct Layout : System.IEquatable<Layout>
    {
        ...
        public override int GetHashCode()
        {
            ...
            hash = (hash * 7) + Padding.GetHashCode();
            hash = (hash * 7) + Margin.GetHashCode();
            hash = (hash * 7) + SizeMinMax.GetHashCode();
            hash = (hash * 7) + PositionMinMax.GetHashCode();
            hash = (hash * 7) + PaddingMinMax.GetHashCode();
            hash = (hash * 7) + MarginMinMax.GetHashCode();
