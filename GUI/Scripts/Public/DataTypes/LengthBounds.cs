...
namespace Nova
{
    ...
    {
        internal const int SizeOf = Internal.LengthBounds.SizeOf;
        ...
        public float Value
        {
            set
            {
                Length val = Length.FixedValue(value);
        ...
        public float Percent
        {
            set
            {
                Length val = Length.Percentage(value);
        ...
        internal bool HasAsymmeticalSides()
        {
            return XY.HasAsymmetricalSides() || X.First != Z.First || X.First != Z.Second;
        }
        ...
        /// </summary>
        [StructLayout(LayoutKind.Explicit, Size = 3 * Length2.Calculated.SizeOf)]
        public readonly struct Calculated : IEquatable<Calculated>
        {
            internal const int SizeOf = 6 * Internal.Length.Calculated.SizeOf;
