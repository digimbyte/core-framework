...
namespace Aura
{
    ...
    public struct BlinnPhong : IEquatable<BlinnPhong>
    {
        ...
        {
            int hash = 13;
            hash = (hash * 7) + Specular.GetHashCode();
            hash = (hash * 7) + Gloss.GetHashCode();
            return hash;
        }
    ...
    public struct Standard : IEquatable<Standard>
    {
        ...
        {
            int hash = 13;
            hash = (hash * 7) + Smoothness.GetHashCode();
            hash = (hash * 7) + Metallic.GetHashCode();
            return hash;
        }
    ...
    public struct StandardSpecular : IEquatable<StandardSpecular>
    {
        ...
        {
            int hash = 13;
            hash = (hash * 7) + SpecularColor.GetHashCode();
            hash = (hash * 7) + Smoothness.GetHashCode();
            return hash;
        }
    ...
    public struct Surface : IEquatable<Surface>
    {
        ...
        public override int GetHashCode()
        {
            int hash = 13;
            hash = (hash * 7) + specularColor.GetHashCode();
            hash = (hash * 7) + param1.GetHashCode();
            hash = (hash * 7) + param2.GetHashCode();
            hash = (hash * 7) + LightingModel.GetHashCode();
            hash = (hash * 7) + ShadowCastingMode.GetHashCode();
            hash = (hash * 7) + ReceiveShadows.GetHashCode();
            return hash;
        }
        ...
        {
            Surface unlit = DefaultUnlit;

            unlit.ShadowCastingMode = ShadowCastingMode.Off;
            unlit.ReceiveShadows = false;
        ...
        {
            Surface matte = DefaultLit;

            matte.ShadowCastingMode = shadowCasting;
            matte.ReceiveShadows = receiveShadows;
        ...
        {
            Color.RGBToHSV(reflectionColor, out float h, out float s, out float _);
            reflectionColor = Color.HSVToRGB(h, s, metallic);
        ...
        internal static readonly Surface DefaultUnlit = new Surface()
        {
        ...
        internal static readonly Surface DefaultLit = new Surface()
        {
