...
namespace Nova
{
    ...
    public enum ImageScaleMode
    {
        ...
        /// </summary>
        Manual = Internal.ImageScaleMode.Manual,
        /// <summary>
        ...
        /// </summary>
        Fit = Internal.ImageScaleMode.Fit,
        /// <summary>
        ...
        Sliced = Internal.ImageScaleMode.Sliced,
        /// <summary>
    ...
    public struct ImageAdjustment : IEquatable<ImageAdjustment>
    {
        ...
        internal static readonly ImageAdjustment Default = new ImageAdjustment()
        {
            UVScale = Vector2.one,
            CenterUV = Vector2.zero,
            Rotation = 0f,
